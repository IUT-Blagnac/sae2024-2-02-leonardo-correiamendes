...
| 1    | link:src/main/java/iut/sae/algo/Efficacite.java    | Java     | Efficacité
| 2    | link:src/main/java/iut/sae/algo/Simplicite.java    | Java     | Simplicité
| 3    | link:src/main/java/iut/sae/algo/Sobriete.java      | Java     | Sobriété      
|==========================================================================
