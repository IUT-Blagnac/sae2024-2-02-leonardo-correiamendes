...
| 1    | link:src/main/java/iut/sae/algo/Efficacite.java[meilleur efficacité]    | Java     | Efficacité
| 2    | link:src/main/java/iut/sae/algo/Simplicite.java[meilleur simplicité]    | Java     | Simplicité
| 3    | link:src/main/java/iut/sae/algo/Sobriete.java[meilleur sobriété]        | Java     | Sobriété      
|==========================================================================
